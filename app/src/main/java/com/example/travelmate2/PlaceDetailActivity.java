    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        down_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PlaceDetailActivity.this, PlacesActivity.class);

                Pair[] pairs = new Pair[1];
                pairs[0] = new Pair<View, String>(down_arrow, "background_image_transition");

                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(PlaceDetailActivity.this, pairs);
